...
/**
 * La portada del modo guiado, tal cual estaba: una sola cosa que hacer, lo
 * demás en voz baja y las cifras como frase.
 *
 * Salió de `page.tsx` sin tocarle una línea al pasar a componente. El modo
 * experto no la modifica ni le añade nada: quien nunca pidió el otro modo ve
 * exactamente el mismo panel de siempre, y ese es el trato.
 */
